...
*}
<div id="eupago_mbwayAdminInfo" class="panel">
	<div class="row">
		<div class="col-lg-12">
			<div class="panel-heading">{l s='Mbway payment info' mod='eupagombw'}</div>
			<div class="tab-content">
				<div class="hidden-sm-down col-xs-3 col-sm-2 col-md-2 col-lg-1"><img src="{$this_path|escape:'htmlall':'UTF-8' mod='eupagombw'}views/img/eupagombw_p.png" alt="euPago" /></div>
					...
					<table style="font-family: Verdana,sans-serif; font-size: 11px; color: black; width: 278px;">
						<tbody>
							...
							<tr>
							  ...
							  <td style="text-align: left;">{convertPrice price=$valor}</td>
							</tr>
						</tbody>
					</table>
				</div>
